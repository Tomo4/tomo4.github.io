...
! function e(t, r, n) {
    ...
    1: [function(e, t, r) {
        ...
        var c = e("./util.js"),
            ...
            b = function() {
                function e(t) {
                    var r;
                    o(this, e), this.target = t, this.listeners = (r = {}, s(r, p, {}), s(r, h, {}), s(r, d, {}), r), this.channelId = f.origin() + ":" + f.sequence.next("channel"), m[this.channelId] = this
                }
                return n(e, [{
                    ...
                    value: function(e) {
                        var t = e.data,
                            r = t.topic,
                            n = !1;
                        t.type === p && this.listeners[p][r] ? (this.listeners[p][r](t), n = !0) : t.type === h && this.listeners[h][r] ? (this.listeners[h][r](t), n = !0) : t.type === d && this.listeners[d][t.id] && (this.listeners[d][t.id](t), delete this.listeners[d][t.id], n = !0), n && "function" == typeof e.stopImmediatePropagation && e.stopImmediatePropagation()
                    }
                }]), e
            }(),
            g = function(e) {
        ...
        "./util.js": 25,
        "babel-runtime/core-js/promise": 38,
        "babel-runtime/helpers/class-call-check": 42,
        "babel-runtime/helpers/create-class": 43,
        "babel-runtime/helpers/define-property": 44,
    ...
    2: [function(e, t, r) {
        ...
        "babel-runtime/core-js/object/keys": 36,
        "babel-runtime/helpers/class-call-check": 42,
        "babel-runtime/helpers/create-class": 43
    }],
    3: [function(e, t, r) {
        ...
        var w = function(e) {
            function t() {
                var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0];
                i(this, t), n(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, e.title), this.type = e.type || p + "/errors/1.0.0/" + e.status + "/" + e.errorCode, this.status = e.status, this.errorCode = e.errorCode, this.title = e.title, this.detail = e.detail, this.instance = e.instance
            }
            return o(t, e), s(t, [{
                key: "toAPIError",
                value: function() {
        ...
        "./util.js": 25,
        "babel-runtime/core-js/object/assign": 31,
        "babel-runtime/core-js/reflect/construct": 39,
        "babel-runtime/helpers/class-call-check": 42,
        "babel-runtime/helpers/create-class": 43,
        "babel-runtime/helpers/get": 45,
        "babel-runtime/helpers/inherits": 46,
    ...
    5: [function(e, t, r) {
        ...
        var l = e("./nintendo/oauth.js"),
            ...
            A = function() {
                function e() {
                    s(this, e), this._readyState = new O["default"], this.client = new b["default"], this.oauth = new c["default"](this), this.event = new p["default"](this), this.api = new d["default"](this), this.error = new v["default"](this)
                }
                return o(e, [{
                    key: "version",
                    get: function() {
        ...
        r["default"] = new A, t.exports = r["default"]
    }, {
        "./chrome.js": 2,
        "./nintendo/api.js": 6,
        "./nintendo/client.js": 14,
        "./nintendo/error.js": 15,
        "./nintendo/event.js": 16,
        "./nintendo/oauth.js": 18,
        "./polyfill/deferred.js": 19,
        "./util.js": 25,
        "babel-runtime/core-js/promise": 38,
        "babel-runtime/helpers/class-call-check": 42,
        "babel-runtime/helpers/create-class": 43,
    ...
    6: [function(e, t, r) {
        ...
        var l = e("url"),
            ...
            v = a(g),
            y = e("./api/missionStatus.js"),
            j = a(y),
            $ = e("./api/user.js"),
            w = a($),
            k = e("./api/userMessage.js"),
            _ = a(k),
            x = e("./api/eshopPrice.js"),
            O = a(x),
            A = e("./api/eshopDemo.js"),
            q = a(A),
            P = {
                path: "/static/jssdk/xdframe.3.0.0.html",
                name: "proxy-frame",
                methods: {
                    user: w["default"],
                    pointWallet: v["default"],
                    missionStatus: j["default"]
                }
            },
            E = {
                path: "/static/jssdk/eshopframe.3.0.0.html",
                name: "eshop-frame",
                methods: {
                    eshopPrice: O["default"],
                    eshopDemo: q["default"]
                }
            },
            I = {
                path: "/static/jssdk/appsframe.3.0.0.html",
                name: "apps-frame",
                methods: {
                    userMessage: _["default"]
                }
            },
            S = function() {
                function e(t) {
                    o(this, e), this.ninAcc = t, this.apiChannels = new h.Channels, this.eshopOrigin = null
                }
                return n(e, [{
                    key: "init",
                    value: function(e) {
                        var t = this,
                            ...
                            o = e.connectOrigin,
                            a = e.appsOrigin,
                            u = "#parent_origin=" + p.origin() + "&connect_origin=" + o,
                            l = [this.ninAcc._loadFrame(P.name, r + P.path + u)];
                        return n && (l.push(this.ninAcc._loadFrame(E.name, n + E.path + u)), this.eshopOrigin = n), a && l.push(this.ninAcc._loadFrame(I.name, a + I.path + u)), s.all(l).then(function(e) {
                            e.forEach(function(e) {
                                ...
                                s && (t.apiChannels.add(new h.WindowChannel(o, r, window.self)), i(s).forEach(function(e) {
                                    t[e] = new s[e](r)
                                }), p.log.debug("[ninAcc.api] " + n + " is loaded"))
                            })
                        })
                    }
                }, {
                    key: "sendRequestToEshop",
                    value: function(e) {
                        var t = arguments.length <= 1 || void 0 === arguments[1] ? null : arguments[1];
                        null == this.eshopOrigin && new d.APIError({
                            status: 400,
                            errorCode: "unsupportedRequest",
                            title: "unsupported request",
                            detail: "Missing eshopOrigin"
                        }), e.origin = this.eshopOrigin, this.sendRequest(e, t)
                    }
                }, {
                    key: "sendRequest",
                    value: function(e) {
        ...
        "./api/eshopDemo.js": 8,
        "./api/eshopPrice.js": 9,
        "./api/missionStatus.js": 10,
        "./api/pointWallet.js": 11,
        "./api/user.js": 12,
        "./api/userMessage.js": 13,
        "babel-runtime/core-js/object/keys": 36,
        "babel-runtime/core-js/promise": 38,
        "babel-runtime/helpers/class-call-check": 42,
        "babel-runtime/helpers/create-class": 43,
    ...
    7: [function(e, t, r) {
            ...
            b = function() {
                ...
                return n(e, [{
                    ...
                    value: function(e, t) {
                        ...
                        r || (r = this.templates[e.template] = p.parse(e.template));
                    ...
                    value: function(e, t) {
                        ...
                        var p = !0,
                            ...
                            d = void 0;
                        try {
                            for (var m, b = a(e.optionalParameters || []); !(p = (m = b.next()).done); p = !0) {
                                var c = m.value;
                                delete r[c]
                            }
                        } catch (f) {
        ...
        "../../error.js": 3,
        "../../util.js": 25,
        "babel-runtime/core-js/get-iterator": 29,
        "babel-runtime/core-js/object/assign": 31,
        "babel-runtime/core-js/object/keys": 36,
        ...
        "babel-runtime/helpers/create-class": 43,
        "babel-runtime/helpers/interop-require-wildcard": 48,
        "babel-runtime/helpers/to-consumable-array": 51,
        "uri-template": 145
    }],
    8: [function(e, t, r) {
        "use strict";
            ...
            c = (e("../../error.js"), function(e) {
                ...
                return o(t, e), s(t, [{
                    ...
                    value: function() {
                        ...
                        n(Object.getPrototypeOf(t.prototype), "create", this).call(this, {
                            id: e.id
                        }, r, o)
                    }
                }, {
            ...
            c = function(e) {
                ...
                return o(t, e), s(t, [{
                    ...
                    get: function() {
                        return {
                            getAll: {
                                template: "/notification/v1/users{/userId}/messages",
                                parameters: ["userId"]
                            },
                            patch: {
                                template: "/notification/v1/users{/userId}/messages{/messageId}",
                                parameters: ["userId", "messageId"]
                            }
                        }
                    }
                }, {
                ...
                return n(e, [{
                    ...
                    value: function(e) {
                        ...
                        return "undefined" == typeof t || "string" != typeof t ? void a.log.error("connectOrigin should be string") : "undefined" == typeof r || "string" != typeof r ? void a.log.error("apiOrigin should be string") : "undefined" == typeof s || "string" != typeof s ? void a.log.error("clientId should be string") : "undefined" == typeof i || "string" != typeof i ? void a.log.error("clientOrigin should be string") : n && "string" != typeof n ? void a.log.error("eshopOrigin should be string") : o && "string" != typeof o ? void a.log.error("appsOrigin should be string") : u && !u instanceof Array ? void a.log.error("scope should be Array.<string>") : l && !l instanceof Array ? void a.log.error("responseType should be Array.<string>") : f && "string" != typeof f ? void a.log.errro("webMessageUri should be string") : c && "string" != typeof c ? void a.log.error("webMessageTarget should be string") : (this.clientId = s, this.clientOrigin = i,
                            this.connectOrigin = t, this.apiOrigin = r, this.eshopOrigin = n, this.appsOrigin = o, this.scope = u || ["openid"], this.responseType = l || ["code", "token", "id_token"], this.webMessageTarget = c || "op-frame", this.webMessageUri = f || "http://localhost:8080/cb", this)
                    }
                }]), e
            }();
    ...
    16: [function(e, t, r) {
            ...
            p = function() {
                ...
                return n(e, [{
                    ...
                    value: function(e) {
                        ...
                        return o ? (this.registeredEvents[n].stop(o), this.listeners[n] = this.listeners[n].filter(function(t) {
                            return t.id !== e
                        }), !0) : !1
                    }
                }, {
        ...
        "babel-runtime/helpers/interop-require-default": 47,
        "babel-runtime/helpers/interop-require-wildcard": 48,
        "babel-runtime/helpers/sliced-to-array": 50
    }],
    17: [function(e, t, r) {
        "use strict";
        var n = e("babel-runtime/helpers/create-class")["default"],
    ...
    18: [function(e, t, r) {
        ...
        var u = e("../util.js"),
            ...
            b = a(m),
            g = {
                opframe: "/static/jssdk/opframe.3.0.0.html",
            ...
            v = "op-frame",
            y = new Date,
            j = "op-immediate-login-frame-" + y.getTime(),
            $ = {
                ...
                return n(e, [{
                    ...
                    value: function(e) {
                        var t = this,
                            ...
                            o = e.eshopOrigin,
                            i = e.appsOrigin;
                        return w[window.name] && (window.name = ""), s.all([this.ninAcc._loadFrame(j, "about:blank"), this.ninAcc._loadFrame(v, r + b["default"].format({
                            pathname: g.opframe,
                            hash: l.encodeQuery({
                    ...
                    value: function(e) {
                        ...
                        l.log.debug("[ninAcc.oauth.getConnectedStatus] send request", n), window.setTimeout(function() {
                            t.immediateLoginFrame.contentWindow ? t.immediateLoginFrame.contentWindow.location.replace(n.uri) : t.immediateLoginFrame.src = n.uri
                    ...
                    value: function(e) {
                        ...
                        var n = h["default"].createWindow({
                            url: r.uri,
                            id: $.unauthenticatedWindow
                        });
    ...
    20: [function(e, t, r) {
        (function(t) {
            ...
            r["default"] = p;
            var h = e("./storage/authorizeRequest.js");
            r.authorizeRequest = a(h);
        ...
        "./storage/authorizeRequest.js": 21,
        "./storage/sessionState.js": 22,
        "./storage/status.js": 23,
        "./storage/token.js": 24,
        "./util.js": 25,
        "babel-runtime/core-js/string/starts-with": 41,
        "babel-runtime/helpers/class-call-check": 42,
        "babel-runtime/helpers/create-class": 43,
        "babel-runtime/helpers/interop-require": 49,
        "babel-runtime/helpers/interop-require-default": 47,
        "babel-runtime/helpers/interop-require-wildcard": 48
    }],
    21: [function(e, t, r) {
                        ...
                        if (t) this.removeItem(this.key(e, t));
                            ...
                            try {
                                for (var u, l = a(r); !(o = (u = l.next()).done); o = !0) {
                                    var c = u.value;
                                    p["default"](c, n) && this.removeItem(c)
                                }
                            } catch (f) {
                                s = !0, i = f
                            } finally {
        ...
        r["default"] = new h, t.exports = r["default"]
    }, {
        "../storage.js": 20,
        "babel-runtime/core-js/get-iterator": 29,
        "babel-runtime/core-js/string/starts-with": 41,
            ...
            d = function(e) {
                ...
                return o(t, e), s(t, [{
                    ...
                    value: function(e) {
                        ...
                        h.log.debug("stored tokens to storage:", n), this.setItem(this.key(e.storage_suffix), n, t)
                    }
                }, {
                    key: "getTokens",
                    value: function(e) {
                        var t = this.getItem(this.key(e.storage_suffix));
                        return t ? (h.log.debug("token not expired: tokenData = ", t), e.scope && e.scope.some(function(e) {
                            return !t.scopes[e]
                        }) ? (h.log.debug("claimed scopes are not fully authorized before: claimed =", e.scope, "authorized =", a(t.scopes)), null) : t) : (h.log.debug("token not found or expired: tokenData = ", t), null)
                    }
                }, {
                    key: "removeTokens",
                    value: function(e) {
    ...
    25: [function(e, t, r) {
        ...
        var y = e("babel-runtime/core-js/object/keys")["default"],
            j = e("babel-runtime/core-js/promise")["default"];
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.unixtime = n, r.unixtimeStamp = o, r.getCookie = s, r.generateId = i, r.decodeQuery = a, r.encodeQuery = u, r.decamelize = l, r.camelize = c, r.pascalize = f, r.parseHeaderText = p, r.delayPromise = h, r.timeoutPromise = d, r.parseOrigin = m, r.getIEVersion = b, r.origin = g, r.invertKeyValues = v;
        var $ = e("./util/log.js");
    ...
    28: [function(e, t, r) {
        ...
        "core-js/library/fn/array/from": 52
    }],
    29: [function(e, t, r) {
        t.exports = {
        ...
        "core-js/library/fn/get-iterator": 53
    }],
    30: [function(e, t, r) {
        t.exports = {
        ...
        "core-js/library/fn/is-iterable": 54
    }],
    31: [function(e, t, r) {
        t.exports = {
        ...
        "core-js/library/fn/object/assign": 55
    }],
    32: [function(e, t, r) {
        t.exports = {
    ...
    39: [function(e, t, r) {
        ...
        "core-js/library/fn/reflect/construct": 63
    }],
    40: [function(e, t, r) {
        t.exports = {
    ...
    41: [function(e, t, r) {
        ...
        "core-js/library/fn/string/starts-with": 65
    }],
    42: [function(e, t, r) {
        "use strict";
    ...
    43: [function(e, t, r) {
        ...
        "babel-runtime/core-js/object/define-property": 33
    }],
    44: [function(e, t, r) {
        "use strict";
        var n = e("babel-runtime/core-js/object/define-property")["default"];
    ...
    45: [function(e, t, r) {
        ...
        r["default"] = function(e, t, r) {
            for (var o = !0; o;) {
                ...
                e = c, t = i, r = a, o = !0, u = c = void 0
            }
        }, r.__esModule = !0
    }, {
        "babel-runtime/core-js/object/get-own-property-descriptor": 35
    }],
    46: [function(e, t, r) {
        "use strict";
        ...
        "babel-runtime/core-js/object/create": 32,
        "babel-runtime/core-js/object/set-prototype-of": 37
    }],
    47: [function(e, t, r) {
        "use strict";
    ...
    50: [function(e, t, r) {
        ...
        "babel-runtime/core-js/get-iterator": 29,
        "babel-runtime/core-js/is-iterable": 30
    }],
    51: [function(e, t, r) {
        "use strict";
        ...
        "babel-runtime/core-js/array/from": 28
    }],
    52: [function(e, t, r) {
        ...
        "../../modules/es6.string.iterator": 136
    }],
    53: [function(e, t, r) {
    ...
    59: [function(e, t, r) {
        ...
        "../../modules/$": 98,
        "../../modules/es6.object.get-own-property-descriptor": 129
    }],
    60: [function(e, t, r) {
    ...
    63: [function(e, t, r) {
        ...
        "../../modules/$.core": 74,
        "../../modules/es6.reflect.construct": 134
    }],
    64: [function(e, t, r) {
    ...
    65: [function(e, t, r) {
        ...
        "../../modules/$.core": 74,
        "../../modules/es6.string.starts-with": 137
    }],
    66: [function(e, t, r) {
        ...
        t.exports = {
            getConstructor: function(e, t, r, o) {
                var c = e(function(e, s) {
                    a(e, c, t), e._i = n.create(null), e._f = void 0, e._l = void 0, e[v] = 0, void 0 != s && l(s, r, e[o], e)
                });
                return s(c.prototype, {
                    ...
                    "delete": function(e) {
                        ...
                        if (r) {
                            var n = r.n,
                                o = r.p;
                            delete t._i[r.i], r.r = !0, o && (o.n = n), n && (n.p = o), t._f == r && (t._f = n), t._l == r && (t._l = o), t[v]--
                        }
                        return !!r
                    },
                    forEach: function(e) {
            ...
            def: function(e, t, r) {
                ...
                return s ? s.v = r : (e._l = s = {
                    ...
                    n: void 0,
                    r: !1
                }, e._f || (e._f = s), n && (n.n = s), e[v]++, "F" !== o && (e._i[o] = s)), e
            },
            getEntry: $,
    ...
    73: [function(e, t, r) {
        ...
        var n = e("./$"),
            ...
            c = e("./$.strict-new"),
            f = e("./$.is-object"),
            p = e("./$.set-to-string-tag"),
            h = e("./$.descriptors");
        t.exports = function(e, t, r, d, m, b) {
            var g = o[e],
                v = g,
                y = m ? "set" : "add",
                j = v && v.prototype,
                $ = {};
            return h && "function" == typeof v && (b || j.forEach && !i(function() {
                (new v).entries().next()
            })) ? (v = t(function(t, r) {
                c(t, v, e), t._c = new g, void 0 != r && l(r, m, t[y], t)
            }), n.each.call("add,clear,delete,forEach,get,has,set,keys,values,entries".split(","), function(e) {
                var t = "add" == e || "set" == e;
                e in j && (!b || "clear" != e) && a(v.prototype, e, function(r, n) {
                    if (!t && b && !f(r)) return "get" == e ? void 0 : !1;
                    var o = this._c[e](0 === r ? 0 : r, n);
                    return t ? this : o
                })
            }), "size" in j && n.setDesc(v.prototype, "size", {
                get: function() {
                    return this._c.size
                }
            })) : (v = d.getConstructor(t, e, m, y), u(v.prototype, r)), p(v, e), $[e] = v, s(s.G + s.W + s.F, $), b || d.setStrong(v, e, m), v
        }
    }, {
        "./$": 98,
        "./$.descriptors": 77,
        ...
        var n = e("./$.global"),
            ...
            a = function(e, t, r) {
                var u, l, c, f = e & a.F,
                    ...
                    v = p ? n : h ? n[t] : (n[t] || {})[i];
                p && (r = t);
                for (u in r) l = !f && v && u in v, l && u in g || (c = l ? v[u] : r[u], g[u] = p && "function" != typeof v[u] ? r[u] : m && l ? s(c, n) : b && v[u] == c ? function(e) {
                    var t = function(t) {
                        return this instanceof e ? new e(t) : e(t)
                    };
                    return t[i] = e[i], t
                }(c) : d && "function" == typeof c ? s(Function.call, c) : c, d && ((g[i] || (g[i] = {}))[u] = c))
            };
    ...
    82: [function(e, t, r) {
        ...
        t.exports = function(e, t, r, l) {
            ...
            if (s(h))
                ...
                for (p = h.call(e); !(f = p.next()).done;) o(p, d, f.value, t)
        }
    }, {
        "./$.an-object": 68,
        "./$.ctx": 75,
    ...
    94: [function(e, t, r) {
        ...
        t.exports = function(e, t, r, v, y, j, $) {
            l(r, t, v);
            var w, k, _ = function(e) {
                ...
                E = P || _(y);
            if (P) {
                var I = f(E.call(new e));
                c(I, x, !0), !n && a(q, d) && i(I, p, g), O && P.name !== b && (A = !0, E = function() {
                    return P.call(this)
                })
            }
            if (n && !$ || !h && !A && q[p] || i(q, p, E), u[t] = E, u[x] = g, y)
                if (w = {
                        values: O ? E : _(b),
                        keys: j ? E : _(m),
                        entries: O ? _("entries") : E
                    }, $)
                    for (k in w) k in q || s(q, k, w[k]);
                else o(o.P + o.F * (h || A), t, w);
            return w
        }
    }, {
        "./$": 98,
    ...
    100: [function(e, t, r) {
        var n, o, s, i = e("./$.global"),
            ...
            p = function() {
                var e, t, r;
                for (f && (e = l.domain) && (l.domain = null, e.exit()); n;) t = n.domain, r = n.fn, t && t.enter(), r(), t && t.exit(), n = n.next;
                o = void 0, e && e.enter()
            };
        if (f) s = function() {
            l.nextTick(p)
    ...
    101: [function(e, t, r) {
        ...
        t.exports = e("./$.fails")(function() {
            ...
            for (var r = o(e), i = arguments, a = i.length, u = 1, l = n.getKeys, c = n.getSymbols, f = n.isEnum; a > u;)
                for (var p, h = s(i[u++]), d = c ? l(h).concat(c(h)) : l(h), m = d.length, b = 0; m > b;) f.call(h, p = d[b++]) && (r[p] = h[p]);
            return r
        } : Object.assign
    }, {
        "./$": 98,
    ...
    111: [function(e, t, r) {
        ...
        t.exports = function(e, t) {
            ...
            return void 0 === i || void 0 == (r = n(i)[s]) ? t : o(r)
        }
    }, {
        "./$.a-function": 66,
        "./$.an-object": 68,
    ...
    115: [function(e, t, r) {
        ...
        p && h || (p = function(e) {
            ...
            f.nextTick(i(v, e, 1))
        } : d ? (o = new d, s = o.port2, o.port1.onmessage = y, n = i(s.postMessage, s, 1)) : c.addEventListener && "function" == typeof postMessage && !c.importScripts ? (n = function(e) {
            c.postMessage(e + "", "*")
        }, c.addEventListener("message", y, !1)) : n = g in l("script") ? function(e) {
        ...
        o(o.S + o.F * !e("./$.iter-detect")(function(e) {
            ...
            from: function(e) {
                var t, r, o, c, f = s(e),
                    ...
                    g = 0,
                    v = l(f);
                if (b && (m = n(m, d > 2 ? h[2] : void 0, 2)), void 0 == v || p == Array && a(v))
                    for (t = u(f.length), r = new p(t); t > g; g++) r[g] = b ? m(f[g], g) : f[g];
                else
                    for (c = v.call(f), r = new p; !(o = c.next()).done; g++) r[g] = b ? i(c, m, [o.value, g], !0) : o.value;
                return r.length = g, r
            }
        })
    }, {
    ...
    133: [function(e, t, r) {
        ...
        var n, o = e("./$"),
            ...
            O = function() {
                ...
                var r = !1;
                try {
                    if (r = k && k.resolve && x(), m(t, k), t.prototype = o.create(k.prototype, {
                            constructor: {
                                value: t
                            }
                        }), t.resolve(5).then(function() {}) instanceof t || (r = !1), r && e("./$.descriptors")) {
                        var n = !1;
                    ...
                    y(function() {
                        for (var n = e.v, o = 1 == e.s, s = 0, a = function(t) {
                                var r, s, i = o ? t.ok : t.fail,
                                    ...
                                    u = t.reject;
                                try {
                                    i ? (o || (e.h = !0), r = i === !0 ? n : i(n), r === t.promise ? u(TypeError("Promise-chain cycle")) : (s = P(r)) ? s.call(r, a, u) : a(r)) : u(n)
                                } catch (l) {
                                    u(l)
                                }
                            }; r.length > s;) a(r[s++]);
                        r.length = 0, e.n = !1, t && setTimeout(function() {
                            var t, r, o = e.p;
                            M(o) && (w ? $.emit("unhandledRejection", n, o) : (t = i.onunhandledrejection) ? t({
                                promise: o,
                                reason: n
        ...
        O || (k = function(e) {
            ...
            then: function(e, t) {
                var r = new E(v(this, k)),
                    n = r.promise,
                    o = this._d;
                return r.ok = "function" == typeof e ? e : !0, r.fail = "function" == typeof t && t, o.c.push(r), o.a && o.a.push(r), o.s && S(o, !1), n
            },
            "catch": function(e) {
            ...
            Promise: k
        }), e("./$.set-to-string-tag")(k, j), e("./$.set-species")(j), n = e("./$.core")[j], l(l.S + l.F * !O, j, {
            reject: function(e) {
                var t = new E(this),
                    r = t.reject;
            ...
            resolve: function(e) {
                if (e instanceof k && A(e.constructor, this)) return e;
                var t = new E(this),
                    r = t.resolve;
                return r(e), t.promise
            }
        }), l(l.S + l.F * !(O && e("./$.iter-detect")(function(e) {
    ...
    134: [function(e, t, r) {
        ...
        o(o.S + o.F * e("./$.fails")(function() {
            ...
            construct: function(e, t) {
                ...
                var l = r.prototype,
                    c = n.create(a(l) ? l : Object.prototype),
    ...
    137: [function(e, t, r) {
        ...
        var n = e("./$.export"),
            ...
            i = "startsWith",
            a = "" [i];
        n(n.P + n.F * e("./$.fails-is-regexp")(i), "String", {
            startsWith: function(e) {
                var t = s(this, e, i),
                    r = arguments,
                    n = o(Math.min(r.length > 1 ? r[1] : void 0, t.length)),
                    u = String(e);
                return a ? a.call(t, u, n) : t.slice(n, n + u.length) === u
            }
        })
    }, {
        "./$.export": 79,
        ...
        (function(e) {
            ! function(n) {
                ...
                function i(e, t) {
                    var r = e.split("@"),
                        n = "";
                    r.length > 1 && (n = r[0] + "@", e = r[1]), e = e.replace(S, ".");
                    var o = e.split("."),
                        i = s(o, t).join(".");
                    return n + i
                }
                ...
                function f(e, t, r) {
                    var n = 0;
                    for (e = r ? T(e / O) : e >> 1, e += T(e / t); e > C * _ >> 1; n += w) e = T(e / C);
                    return T(n + (C + 1) * e / (e + x))
                }

                function p(e) {
                    var t, r, n, s, i, a, c, p, h, d, m = [],
                        b = e.length,
                        g = 0,
                        v = q,
                        y = A;
                    ...
                    for (s = r > 0 ? r + 1 : 0; b > s;) {
                        for (i = g, a = 1, c = w; s >= b && o("invalid-input"), p = l(e.charCodeAt(s++)), (p >= w || p > T(($ - g) / a)) && o("overflow"), g += p * a, h = y >= c ? k : c >= y + _ ? _ : c - y, !(h > p); c += w) d = w - h, a > T($ / d) && o("overflow"), a *= d;
                        t = m.length + 1, y = f(g - i, t, 0 == i), T(g / t) > $ - v && o("overflow"), v += T(g / t), g %= t, m.splice(g++, 0, v)
                    }
                    return u(m)
                }

                function h(e) {
                    var t, r, n, s, i, u, l, p, h, d, m, b, g, v, y, j = [];
                    for (e = a(e), b = e.length, t = q, r = 0, i = A, u = 0; b > u; ++u) m = e[u], 128 > m && j.push(F(m));
                    for (n = s = j.length, s && j.push(P); b > n;) {
                        ...
                        for (g = n + 1, l - t > T(($ - r) / g) && o("overflow"), r += (l - t) * g, t = l, u = 0; b > u; ++u)
                            if (m = e[u], t > m && ++r > $ && o("overflow"), m == t) {
                                for (p = r, h = w; d = i >= h ? k : h >= i + _ ? _ : h - i, !(d > p); h += w) y = p - d, v = w - d, j.push(F(c(d + y % v, 0))), p = T(y / v);
                                j.push(F(c(p, 0))), i = f(r, g, n == s), r = 0, ++n
                            }++ r, ++t
                    }
                    return j.join("")
                }
                ...
                if (y = {
                    ...
                    if (t.exports == b) g.exports = y;
                    else
                        for (j in y) y.hasOwnProperty(j) && (b[j] = y[j]);
                else n.punycode = y
            }(this)
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
    }, {}],
    142: [function(e, t, r) {
        ...
        t.exports = function(e, t, r, s) {
            ...
            u > 0 && l > u && (l = u);
            for (var c = 0; l > c; ++c) {
                var f, p, h, d, m = e[c].replace(a, "%20"),
                    b = m.indexOf(r);
                b >= 0 ? (f = m.substr(0, b), p = m.substr(b + 1)) : (f = m, p = ""), h = decodeURIComponent(f), d = decodeURIComponent(p), n(i, h) ? o(i[h]) ? i[h].push(d) : i[h] = [i[h], d] : i[h] = d
            }
            return i
        };
        ...
        t.exports = function() {
            ...
            var r = {
                parse: function(r, n) {
                    ...
                    function s() {
                        var e, t, r;
                        for (r = y, e = [], t = d(), null === t && (t = i()); null !== t;) e.push(t), t = d(), null === t && (t = i());
                    ...
                    function i() {
                        var e, t, n, s, i, u;
                        return i = y, u = y, 123 === r.charCodeAt(y) ? (e = "{", y++) : (e = null, 0 === j && o('"{"')), null !== e ? (t = a(), null !== t ? (n = l(), null !== n ? (125 === r.charCodeAt(y) ? (s = "}", y++) : (s = null, 0 === j && o('"}"')), null !== s ? e = [e, t, n, s] : (e = null, y = u)) : (e = null, y = u)) : (e = null, y = u)) : (e = null, y = u), null !== e && (e = function(e, t, r) {
                            return x(t, r)
                        }(i, e[1], e[2])), null === e && (y = i), e
                    }

                    function a() {
                        var e;
                        return /^[\/;:.?&+#]/.test(r.charAt(y)) ? (e = r.charAt(y), y++) : (e = null, 0 === j && o("[\\/;:.?&+#]")), null === e && (e = ""), e
                    }

                    function u() {
                        var e;
                        return "{/" === r.substr(y, 2) ? (e = "{/", y += 2) : (e = null, 0 === j && o('"{/"')), e
                    }

                    function l() {
                        var e, t, n, s, i, a, u, l;
                        if (i = y, a = y, e = c(), null !== e) {
                            for (t = [], u = y, l = y, 44 === r.charCodeAt(y) ? (n = ",", y++) : (n = null, 0 === j && o('","')), null !== n ? (s = c(), null !== s ? n = [n, s] : (n = null, y = l)) : (n = null, y = l), null !== n && (n = function(e, t) {
                                    return t
                                }(u, n[1])), null === n && (y = u); null !== n;) t.push(n), u = y, l = y, 44 === r.charCodeAt(y) ? (n = ",", y++) : (n = null, 0 === j && o('","')), null !== n ? (s = c(), null !== s ? n = [n, s] : (n = null, y = l)) : (n = null, y = l), null !== n && (n = function(e, t) {
                                return t
                            }(u, n[1])), null === n && (y = u);
                            null !== t ? e = [e, t] : (e = null, y = a)
                        } else e = null,
                            y = a;
                        return null !== e && (e = function(e, t, r) {
                            return r.unshift(t), r
                        }(i, e[0], e[1])), null === e && (y = i), e
                    }

                    function c() {
                        var e, t, n, s, i;
                        for (s = y, i = y, e = [], /^[a-zA-Z0-9_.%]/.test(r.charAt(y)) ? (t = r.charAt(y), y++) : (t = null, 0 === j && o("[a-zA-Z0-9_.%]")); null !== t;) e.push(t), /^[a-zA-Z0-9_.%]/.test(r.charAt(y)) ? (t = r.charAt(y), y++) : (t = null, 0 === j && o("[a-zA-Z0-9_.%]"));
                        return null !== e ? (t = f(), null === t && (t = p()), t = null !== t ? t : "", null !== t ? (n = m(), n = null !== n ? n : "", null !== n ? e = [e, t, n] : (e = null, y = i)) : (e = null, y = i)) : (e = null, y = i), null !== e && (e = function(e, t, r, n) {
                            return r = r || {}, {
                                name: t.join(""),
                        ...
                        }(s, e[0], e[1], e[2])), null === e && (y = s), e
                    }

                    function f() {
                        var e, t;
                        return t = y, e = h(), null !== e && (e = function(e, t) {
                            return {
                                cut: t
                            }
                        }(t, e)), null === e && (y = t), e
                    ...
                    function p() {
                        var e, t;
                        return t = y, 42 === r.charCodeAt(y) ? (e = "*", y++) : (e = null, 0 === j && o('"*"')), null !== e && (e = function(e, t) {
                            return {
                                listMarker: t
                            }
                        }(t, e)), null === e && (y = t), e
                    ...
                    function h() {
                        var e, t, n, s, i;
                        if (s = y, i = y, 58 === r.charCodeAt(y) ? (e = ":", y++) : (e = null, 0 === j && o('":"')), null !== e) {
                            if (/^[0-9]/.test(r.charAt(y)) ? (n = r.charAt(y), y++) : (n = null, 0 === j && o("[0-9]")), null !== n)
                                for (t = []; null !== n;) t.push(n), /^[0-9]/.test(r.charAt(y)) ? (n = r.charAt(y), y++) : (n = null, 0 === j && o("[0-9]"));
                            else t = null;
                            null !== t ? e = [e, t] : (e = null, y = i)
                        } else e = null, y = i;
                        return null !== e && (e = function(e, t) {
                    ...
                    function d() {
                        var e, t, n;
                        if (n = y, /^[^{]/.test(r.charAt(y)) ? (t = r.charAt(y), y++) : (t = null, 0 === j && o("[^{]")), null !== t)
                            for (e = []; null !== t;) e.push(t), /^[^{]/.test(r.charAt(y)) ? (t = r.charAt(y), y++) : (t = null, 0 === j && o("[^{]"));
                        else e = null;
                        return null !== e && (e = function(e, t) {
                            return t.join("")
                        }(n, e)), null === e && (y = n), e
                    ...
                    function m() {
                        var e, t, n, s, i;
                        if (s = y, i = y, 40 === r.charCodeAt(y) ? (e = "(", y++) : (e = null, 0 === j && o('"("')), null !== e) {
                            if (/^[^)]/.test(r.charAt(y)) ? (n = r.charAt(y), y++) : (n = null, 0 === j && o("[^)]")), null !== n)
                                for (t = []; null !== n;) t.push(n), /^[^)]/.test(r.charAt(y)) ? (n = r.charAt(y), y++) : (n = null, 0 === j && o("[^)]"));
                            else t = null;
                            null !== t ? (41 === r.charCodeAt(y) ? (n = ")", y++) : (n = null, 0 === j && o('")"')), null !== n ? e = [e, t, n] : (e = null, y = i)) : (e = null, y = i)
                        } else e = null, y = i;
                        return null !== e && (e = function(e, t) {
                            return t.join("")
                        }(s, e[1])), null === e && (y = s), e
                    ...
                    function g() {
                        for (var e = 1, t = 1, n = !1, o = 0; o < Math.max(y, $); o++) {
                            var s = r.charAt(o);
                    ...
                    if (void 0 !== n) {
                        if (void 0 === v[n]) throw new Error("Invalid rule name: " + t(n) + ".")
                    } else n = "uriTemplate";
                    var y = 0,
                        j = 0,
                        $ = 0,
                        ...
                        x = k.expression,
                        O = v[n]();
                    if (null === O || y !== r.length) {
                        var A = Math.max(y, $),
                            q = A < r.length ? r.charAt(A) : null,
                            P = g();
                        throw new this.SyntaxError(b(w), q, A, P.line, P.column)
                    }
                    return O
                },
                toSource: function() {
    ...
    146: [function(e, t, r) {
        (function() {
            var r, n, o, s, i, a, u, l, c, f, p, h, d, m, b, g, v, y, j, $ = function(e, t) {
                    return function() {
                        return e.apply(t, arguments)
                    }
                },
            ...
            p = e("./encoders"), f = f = function() {
                ...
                function t() {
                    return this.explodeArray = $(this.explodeArray, this), this.stringifySingle = $(this.stringifySingle, this), h = t.__super__.constructor.apply(this, arguments)
                }
    ...
    147: [function(e, t, r) {
        (function() {
            var t;
            t = e("pct-encode"), r.U = t(/[^\w~.-]/g), r["U+R"] = t(/[^\w.~:\/\?#\[\]@!\$&'()*+,;=%-]|%(?!\d\d)/g)
        }).call(this)
    }, {
        "pct-encode": 140
    }],
    148: [function(e, t, r) {
        ...
        n.prototype.parse = function(e, t, r) {
            ...
            if (!_[o] && (i || o && !x[o])) {
                ...
                if (!m)
                    for (var b = this.hostname.split(/\./), l = 0, A = b.length; A > l; l++) {
                        var q = b[l];
                        if (q && !q.match($)) {
                            for (var P = "", E = 0, I = q.length; I > E; E++) P += q.charCodeAt(E) > 127 ? "x" : q[E];
                            if (!P.match($)) {
                                var S = b.slice(0, l),
                                    M = b.slice(l + 1),
                                    C = q.match(w);
                                C && (S.push(C[1]), M.unshift(C[2])), M.length && (n = "/" + M.join(".") + n), this.hostname = S.join(".");
                                break
                            }
                        }
                    }
                if (this.hostname = this.hostname.length > j ? "" : this.hostname.toLowerCase(), !m) {
                    for (var T = this.hostname.split("."), F = [], l = 0; l < T.length; ++l) {
                        var R = T[l];
                        F.push(R.match(/[^A-Za-z0-9_-]/) ? "xn--" + p.encode(R) : R)
                    }
            ...
            if (!k[s])
                for (var l = 0, A = g.length; A > l; l++) {
                    var L = g[l],
                        N = encodeURIComponent(L);
                    N === L && (N = escape(L)), n = n.split(L).join(N)
                }
            var W = n.indexOf("#"); - 1 !== W && (this.hash = n.substr(W), n = n.slice(0, W));
            var D = n.indexOf("?");
            if (-1 !== D ? (this.search = n.substr(D), this.query = n.substr(D + 1), t && (this.query = O.parse(this.query)), n = n.slice(0, D)) : t && (this.search = "", this.query = {}), n && (this.pathname = n), x[s] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
                var z = this.pathname || "",
                    R = this.search || "";
                this.path = z + R
            }
            ...
            var t = this.protocol || "",
                ...
                o = !1,
                s = "";
            this.host ? o = e + this.host : this.hostname && (o = e + (-1 === this.hostname.indexOf(":") ? this.hostname : "[" + this.hostname + "]"), this.port && (o += ":" + this.port)), this.query && l(this.query) && Object.keys(this.query).length && (s = O.stringify(this.query));
            ...
            var a = r.pathname && "/" === r.pathname.charAt(0),
                ...
                p = l || a || r.host && e.pathname,
                h = p,
                d = r.pathname && r.pathname.split("/") || [],
                o = e.pathname && e.pathname.split("/") || [],
                m = r.protocol && !x[r.protocol];
            if (m && (r.hostname = "", r.port = null, r.host && ("" === d[0] ? d[0] = r.host : d.unshift(r.host)), r.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === o[0] ? o[0] = e.host : o.unshift(e.host)), e.host = null), p = p && ("" === o[0] || "" === d[0])), l) r.host = e.host || "" === e.host ? e.host : r.host, r.hostname = e.hostname || "" === e.hostname ? e.hostname : r.hostname, r.search = e.search, r.query = e.query, d = o;
            ...
            for (var g = d.slice(-1)[0], v = (r.host || e.host) && ("." === g || ".." === g) || "" === g, y = 0, j = d.length; j >= 0; j--) g = d[j], "." == g ? d.splice(j, 1) : ".." === g ? (d.splice(j, 1), y++) : y && (d.splice(j, 1), y--);
            if (!p && !h)
                for (; y--; y) d.unshift("..");
            !p || "" === d[0] || d[0] && "/" === d[0].charAt(0) || d.unshift(""), v && "/" !== d.join("/").substr(-1) && d.push("");
            ...
            return p = p || r.host && d.length, p && !$ && d.unshift(""), d.length ? r.pathname = d.join("/") : (r.pathname = null, r.path = null), c(r.pathname) && c(r.search) || (r.path = (r.pathname ? r.pathname : "") + (r.search ? r.search : "")), r.auth = e.auth || r.auth, r.slashes = r.slashes || e.slashes, r.href = r.format(), r
